...
class ApiClient {
  ApiClient({this.basePath = 'https://splathon-api-dev.appspot.com/splathon', this.authentication,});
  ...
  static dynamic _deserialize(dynamic value, String targetType, {bool growable = false}) {
    try {
      switch (targetType) {
        ...
        case 'DeleteQualifierRequest':
          return DeleteQualifierRequest.fromJson(value);
        case 'Error':
