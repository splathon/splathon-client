...
class MatchApi {
  ...
  Future<GetNextMatchResponse> getNextMatch(int eventId, String X_SPLATHON_API_TOKEN, { int teamId }) async {
    ...
    // create path and map variables
    String path = "/v{eventId}/next-match".replaceAll("{format}","json").replaceAll("{" + "eventId" + "}", eventId.toString());
    ...
    if(response.statusCode >= 400) {
      ...
      return apiClient.deserialize(response.body, 'GetNextMatchResponse') as GetNextMatchResponse;
    } else {
      return null;
    }
  }
